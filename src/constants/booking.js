/** Duración en minutos de la PRIMERA cita (única que se agenda en la web). */
export const SERVICE_DURATIONS = {
  ...
  'Hollywood Peel (Pico Láser)': 40,
  'Melasma (Pico Segundo)': 60,
  'Eliminación de Microblading': 30,
  'Eliminación de Manchas en Manos': 60,
  'Peeling Químico': 45,
  ...
  'Suero Quelación': 240,
  'Suero Neuro Hormonal': 90,
  Exosomas: 60,
  'Inmunoterapia (NK y Linfocitos)': 60,
  'Células Dendríticas': 60,
  'Eliminación de Tatuajes (Pico Láser)': 60,
  Criolipólisis: 90,
  'Criolipólisis (Paquetes)': 90,
  'Ice Pro Criolipólisis': 90,
  'Depilación Láser': 35,
  /** El doctor indicó 40–45 min; 45 evita recortar el consultorio. */
  Hidrofacial: 45,
